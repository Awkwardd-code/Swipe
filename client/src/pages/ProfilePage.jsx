				...
				<div className='mt-8 sm:mx-auto sm:w-full sm:max-w-md'>
					<div className='bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-gray-200'>
						<form onSubmit={handleSubmit} className='space-y-6'>
							...
							{/* GENDER */}
							<div>
								<span className='block text-sm font-medium text-gray-700 mb-2 text-left'>Gender</span>
							...
							{/* GENDER PREFERENCE */}
							<div>
								<span className='block text-sm font-medium text-gray-700 mb-2 text-left'>Gender Preference</span>
								<div className='flex space-x-4'>
							...
							<div>
								<label htmlFor='bio' className='block text-sm text-left font-medium text-gray-700'>
									Bio
								</label>
								<div className='mt-1'>
									<textarea
							...
							<div>
								<label className='block text-sm text-left font-medium text-gray-700'>Cover Image</label>
